...
from dbot.utils.ann_model import prepare_data_for_ann
...
def evaluate_dataset(data: pd.DataFrame, timeframe: str):
    ...
    if signal_density < 2:
        score2 = 0
    elif signal_density < 4:
        score2 = 1
    elif signal_density < 6:
        score2 = 2
    elif signal_density < 8:
        score2 = 3
    else:
        score2 = 4
