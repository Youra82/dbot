...
from dbot.utils.trade_manager import check_and_open_new_position, housekeeper_routine, is_trade_locked, set_trade_lock, Bias
...
def run_test():
    try:
        ...
        with patch('dbot.utils.trade_manager.get_titan_signal', return_value=('buy', None)):
